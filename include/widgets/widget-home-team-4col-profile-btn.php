<?php
/*
 * Plugin Name: MT - Home: Team 4 Col w/ Profile Btn
 * Plugin URI: http://www.matchthemes.com
 * Description: Homepage: Display team members in 4 columns each with profile button
 * Version: 1.0
 * Author: MatchThemes
 ...
 */
add_action( 'widgets_init', 'mt_home_team_4col_profile' );

/*
 * Register widget.
 */
function mt_home_team_4col_profile() {
	register_widget( 'mt_home_team_4col_profile_w' );
}

/*
 * Widget class.
 */
class mt_home_team_4col_profile_w extends WP_Widget {

	/* ---------------------------- */
	/* -------- Widget setup -------- */
	/* ---------------------------- */
	
	function mt_home_team_4col_profile_w() {
	
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mt_home_team_4col_profile_w', 'description' => __('Homepage: Display team members in 4 columns each with profile button', 'match') );

		/* Create the widget. */
		$this->WP_Widget( 'mt_home_team_4col_profile_w', __('MT - Home: Team 4 Col w/ Profile Btn', 'match'), $widget_ops);
	}
	...
	//	if ( $title )
     ...
     <section id="meet-lawyers-4col" class="home-widget margin-t">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
